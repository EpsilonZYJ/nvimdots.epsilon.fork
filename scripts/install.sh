...
info "This script will install EpsilonZYJ/nvimdots.epsilon.fork to:"
echo "${DEST_DIR}"
...
if [[ "${USE_SSH}" -eq "1" ]]; then
	clone_repo "git@github.com:EpsilonZYJ/nvimdots.epsilon.fork.git"
else
	clone_repo "https://github.com/EpsilonZYJ/nvimdots.epsilon.fork.git"
fi
...
- Project Homepage:
    ${tty_underline}https://github.com/EpsilonZYJ/nvimdots.epsilon.fork${tty_reset}
