...
'@
	...
	info -Msg "This script will install EpsilonZYJ/nvimdots.epsilon.fork to:"
	...
	if ($USE_SSH) {
		clone_repo -WithURL 'git@github.com:EpsilonZYJ/nvimdots.epsilon.fork.git'
	} else {
		clone_repo -WithURL 'https://github.com/EpsilonZYJ/nvimdots.epsilon.fork.git'
	}
...
- Project Homepage:
    https://github.com/EpsilonZYJ/nvimdots.epsilon.fork
    ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
